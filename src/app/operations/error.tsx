...
export default function OperationsError({
  ...
  useEffect(() => {
    console.error('Operations Portal error:', error);
  }, [error]);
    ...
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white rounded-2xl border border-slate-200/80 shadow-md p-8 text-center space-y-5">
        ...
        <div className="space-y-2">
          <h2 className="text-lg font-black text-slate-900 tracking-tight">Operations System Notice</h2>
          <p className="text-xs text-slate-500 leading-relaxed">
            There was an issue loading the operations workspace data.
          </p>
          {error?.digest && (
